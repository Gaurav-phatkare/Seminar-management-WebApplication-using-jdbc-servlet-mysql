					...
					<div class="row d-flex">
						...
						<div class="container">
							...
							<!--<div class="col-sm-4 createSegment">
								...
								<a href="<%=request.getContextPath()%>/newF"
							...
							<div class="overflow-x">
								<table style="width: 100%;" id="filtertable"
									...
									<tbody>
										<!--   for (Todo todo: todos) {  -->
										<c:forEach var="admintable" items="${listSeminarTable}">

											<tr>
												<td><c:out value="${admintable.seminar_ID}" /></td>
												<td><c:out value="${admintable.topic}" /></td>
												<td><c:out value="${admintable.mentor_Name}" /></td>
												<td><c:out value="${admintable.mentor_ID}" /></td>
												<td><c:out value="${admintable.description}" /></td>
												<td><c:out value="${admintable.date_Time}" /></td>
												<td><c:out value="${admintable.active_Status}" /></td>
												<!--<td><a
													href="<c:out value="${admintable.survey_Link}" />">Survey
														Link</a></td>-->
												<td><a
													href="<c:out value="${admintable.seminar_Link}" />" target = "blank">Seminar
														Link</a></td>
														
														
												<!--<td><c:out value="${admintable.documents}" /></td>-->
												<!--<td><c:out value="${admintable.feedback_Form}" />Feedback Link</td> -->

												<td><a
													href="<c:out value="${admintable.feedback_Form}" />" target = "blank">Feedback
														Link</a></td>
												...
												<td><div class="btn-group">
														<a
															href="editF?seminar_ID=<c:out value='${admintable.seminar_ID}' />"
													...
													<div class="btn-group">
														<a
															href="deleteS?seminar_ID=<c:out value='${admintable.seminar_ID}' />"
			...
			<div class="col-md-12 main-datatable">
				<div class="card_body">
					<div class="row d-flex">
						...
						<div class="container">
							<h3 style = "font-family: 'Roboto', sans-serif;"><strong>Mentors Information</strong></h3>
							<!--<div class="col-sm-4 createSegment">
								...
								<table style="width: 100%;" id="filtertable1"
									...
									<thead>
										<tr>
											...
											<th style="min-width: 50px;">contact</th>
											<th style="min-width: 50px;">email</th>
											<th style="min-width: 50px;">qualification</th>
											<th style="min-width: 50px;">work_experience</th>
									...
									<tbody>
										<!--   for (Todo todo: todos) {  -->
										<c:forEach var="mentortable" items="${listMentorTable}">

											<tr>
												<td><c:out value="${mentortable.ment_ID}" /></td>
												<td><c:out value="${mentortable.name}" /></td>
												<td><c:out value="${mentortable.contact}" /></td>
												
												
												<td><a
													href= "mailto:<c:out value="${mentortable.email}" />" target = "blank"><c:out value="${mentortable.email}" /></a></td>
												
												<!--<td><c:out value="${mentorTable.email}" /></td>-->
												<td><c:out value="${mentortable.qualification}" /></td>
												<td><c:out value="${mentortable.work_experience}" /></td>
												<td><c:out value="${mentortable.city}" /></td>
												<!--<td><a
													href="<c:out value="${mentortable.survey_Link}" />">Survey
														Link</a></td>-->
												<!--<td><a
													href="<c:out value="${mentortable.seminar_Link}" />">Seminar
														Link</a></td>-->
														
														
												<!--<td><c:out value="${mentortable.documents}" /></td>-->
												<!--<td><c:out value="${mentortable.feedback_Form}" />Feedback Link</td> -->

												<!--<td><a
													href="<c:out value="${mentortable.feedback_Form}" />">Feedback
														Link</a></td>-->
												...
												<td><!--<div class="btn-group">
														<a
															href="editF?seminar_ID=<c:out value='${mentortable.seminar_ID}' />"
															class=" dropdown_icon"> <i
															class="fa fa-pencil-square-o"></i>
														</a>
													</div> &nbsp;&nbsp;&nbsp;&nbsp;-->
													<div class="btn-group">
														<a
															href="deleteS?ment_ID=<c:out value='${mentortable.ment_ID}' />"
															class=" dropdown_icon"> <i class="fa fa-trash"></i>
														</a>
													</div></td>
												...
												<!--<td><div class="btn-group">
													...
													<div class="btn-group">
														<a
															href="delete?seminar_ID=<c:out value='${mentortable.seminar_ID}' />"
															class=" dropdown_icon"> <i class="fa fa-trash"></i>
														</a>
													</div>
												</td>-->
									...
									<div class="menu">
										...
										<ul>
											...
											<li><img
												...
												href="http://localhost:9494/Event_Organizer_a/IndexPage.jsp">Logout</li>
